...
{
		"randomGeneratorTestGroup",
		"registrationMailSenderTestGroup"
})
@PropertySource(
{
...
public class UserRegistrationServiceTest extends AbstractGetlinksTest
{
	...
	@Test
	public void testRegisterUser_SERVICE() throws MessagingException
	{
	...
	@Test(dependsOnMethods = "testRegisterUser_SERVICE")
	public void testActivateUser_SERVICE()
	{
	...
	@Test(dependsOnMethods = "testActivateUser_SERVICE")
	public void testGenerateReactivationEmail_SERVICE() throws MessagingException
	{
	...
	@Test(dependsOnMethods = "testGenerateReactivationEmail_SERVICE")
	public void testGenerateResetPasswordEmail_SERVICE() throws MessagingException
	{
